...
public class BoardController {
	...
	public String boardView(Model model, String bI) {
		...
		ArrayList<CommentDTO> commentList = service.commentList(bI);
	...
	@PostMapping("board/viewForm")
	public String CommentProc(Model model, String bI, String content) {
		...
		String msg = service.CommentProc(content, bI, writer);
		if (msg.equals("게시글 작성 성공"))
			return "redirect:/board/viewForm?bI=" + bI;

		return "board/viewForm?bI=" + bI;
	}
